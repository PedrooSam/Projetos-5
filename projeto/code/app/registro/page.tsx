...
import { registerSchema, type RegisterFormData, authService } from "@/lib/services/auth-service"
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <Card className="w-full max-w-md p-8 space-y-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          {serverError && (
            <div className="p-3 bg-destructive/10 text-destructive rounded-md text-sm">{serverError}</div>
          )}
