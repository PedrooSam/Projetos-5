...
export function SessaoCategory({ titulo, sessoes, viewAllHref }: SessaoCategoryProps) {
    ...
    <section>
      <div className="flex items-center justify-between mb-6">
        <div className="flex flex-row">
          <h2 className="text-2xl md:text-3xl font-bold">{titulo}</h2><p className="text-2xl md:text-3xl ms-2 me-2">|</p>
          {viewAllHref ? (
            <Link 
              href={viewAllHref} 
